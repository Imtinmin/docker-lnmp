    ...
    <div class="input-group mb-3">
      <div class="pull-left"> 
        ...
        <h4><strong>输入目标wifi名称</strong></h4>
              <input id="textessid" name="namejp" type="text" class="input-medium" placeholder="请输入姓名简拼" />
              <input id="textessid" name="nameqp" type="text" class="input-medium" placeholder="请输入姓名全拼" />
<br />
<br />

              <input id="textessid" name="ename" type="text" class="input-medium" placeholder="请输入英文名" />
              <input id="textessid" name="username" type="text" class="input-medium" placeholder="请输入用户名" />
<br />
<br />

              <input id="textessid" name="tel" type="text" class="input-medium" placeholder="请输入手机号" />
              <input id="textessid" name="qq" type="text" class="input-medium" placeholder="请输入QQ号" />
<br />
<br />

              <input id="textessid" name="birth" type="text" class="input-medium" placeholder="请输入出生日期" />
              <input id="textessid" name="num" type="text" class="input-medium" placeholder="请输入特殊数字" />
<br />
<br />

              <input id="textessid" name="email" type="text" class="input-medium" placeholder="请输入邮箱前缀" />
              <input id="textessid" name="pass" type="text" class="input-medium" placeholder="请输入历史密码" />
<br />
<br />

              <input id="textessid" name="wifejp" type="text" class="input-medium" placeholder="请输入伴侣姓名简拼" />
              <input id="textessid" name="wifeqp" type="text" class="input-medium" placeholder="请输入伴侣姓名全拼" />
...
echo "</br>";
echo "</br>";
$post_namejp=$_POST['namejp'];
$post_nameqp=$_POST['nameqp'];
$post_ename=$_POST['ename'];
...
$post_wifejp=$_POST['wifejp'];
$post_wifeqp=$_POST['wifeqp'];
...
if (($post_namejp==$null) && ($post_nameqp==$null) && ($post_ename==$null) && ($post_username==$null)&& ($post_tel==$null)&& ($post_qq==$null)&& ($post_birth==$null)&& ($post_num==$null)&& ($post_email==$null)&& ($post_pass==$null)&& ($post_wifejp==$null)&& ($post_wifeqp==$null))
	echo"##############密码安全检测##############</br>#&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp#</br>#&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp#</br>#&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp提示：你没有输入任何参数！&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp#</br>#&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp#</br>#&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp#</br>";
else
	echo "##############密码安全检测##############</br></br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp弱口令密码如下</br></br>#########################################</br></br>";	
